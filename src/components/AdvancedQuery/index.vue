...
例：queryColumns: [
        {
          ...
          placeholder: "请选择年度",    
          type: "select",            // 必传
          multiple:true,             //select框是否多选，已数组形式传值，默认单选
    ...
    <div class="wrapper">
      <div class="header">
        ...
        >
          <fu-button
            ...
            >查询</fu-button
          >
          <fu-button v-if="showTopResetButton" :size="size" @click="resetForm"
            >重置</fu-button
          >
          <fu-button
            type="primary"
      ...
      >
        ...
        <div class="form">
          ...
          <div class="btn">
            <fu-button :size="size" type="success" @click="search"
              >查询</fu-button
            >
            <fu-button :size="size" @click="resetForm">重置</fu-button>
          </div>
        </div>
      </fu-popover>
    </div>
