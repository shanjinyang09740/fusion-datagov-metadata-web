    ...
    <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
      <el-tab-pane label="基本属性" name="first">
        <fu-form
          ...
          :fu-data="baseForm"
        >
          <fu-form-item label="名称" prop="themeName">
            <fu-input
              :disabled="disabled"
          ...
          <fu-form-item label="英文名" prop="themeName">
            <fu-input
              :disabled="disabled"
              v-model="baseForm.baseName"
              placeholder="请输入"
          ...
          <fu-form-item label="编码" prop="themeCode">
            <fu-input
              :disabled="disabled"
          ...
          <fu-form-item label="别名" prop="themeCode">
            <fu-input
              :disabled="disabled"
              v-model="baseForm.baseCode"
              placeholder="请输入"
          ...
          <fu-form-item label="层级" prop="themeCode">
            <fu-input
              :disabled="disabled"
              v-model="baseForm.baseCode"
              placeholder="请输入"
          ...
          <fu-form-item label="顺序号" prop="themeCode">
            <fu-input
              :disabled="disabled"
              v-model="baseForm.baseCode"
              placeholder="请输入"
          ...
          <fu-form-item label="量纲" prop="themeCode">
            <fu-select
              v-model="baseForm.code"
              :disabled="disabled"
              placeholder="请选择"
          ...
          <fu-form-item label="计量单位" prop="themeCode">
            <fu-input
              v-model="baseForm.baseCode"
              :disabled="disabled"
              placeholder="请输入"
          ...
          <fu-form-item label="指标类型(一)" prop="themeCode">
            <fu-select
              v-model="baseForm.code"
              :disabled="disabled"
              placeholder="请选择"
          ...
          <fu-form-item label="指标类型(二)" prop="themeCode">
            <fu-select
              v-model="baseForm.code"
              :disabled="disabled"
              placeholder="请选择"
          ...
          <fu-form-item label="指标类型(三)" prop="themeCode">
            <fu-select
              v-model="baseForm.code"
              :disabled="disabled"
              placeholder="请选择"
          ...
          <fu-form-item label="指标出处" prop="themeCode">
            <fu-select
              v-model="baseForm.code"
              :disabled="disabled"
              placeholder="请选择"
          ...
          <fu-form-item label="指标用途" prop="themeCode">
            <fu-input
              type="textarea"
              v-model="baseForm.baseCode"
              :disabled="disabled"
          ...
          <fu-form-item label="指标解释" prop="themeCode">
            <fu-input
              type="textarea"
              v-model="baseForm.baseCode"
              :disabled="disabled"
          ...
          <fu-form-item label="内涵定义" prop="themeCode">
            <fu-input
              type="textarea"
              v-model="baseForm.baseCode"
              :disabled="disabled"
          ...
          <fu-form-item label="外延定义" prop="themeCode">
            <fu-input
              type="textarea"
              v-model="baseForm.baseCode"
              :disabled="disabled"
          ...
          <fu-form-item label="资料来源" prop="themeCode">
            <fu-input
              type="textarea"
              v-model="baseForm.baseCode"
              :disabled="disabled"
          ...
          <fu-form-item label="填报说明" prop="themeCode">
            <fu-input
              type="textarea"
              v-model="baseForm.baseCode"
              :disabled="disabled"
      ...
      <el-tab-pane label="管理属性" name="second"
        ><fu-form
          ...
          :fu-data="manageForm"
        >
          <fu-form-item label="指标状态" prop="state">
            <fu-select
          ...
          <fu-form-item label="指标启用时间" prop="themeName">
            <fu-input
          ...
          <fu-form-item label="指标停用时间" prop="themeCode">
            <fu-input
          ...
          <fu-form-item label="" prop="themeCode">
            <fu-input
              v-model="manageForm.manageCode"
              :disabled="disabled"
              placeholder="请输入"
      ...
      <el-tab-pane label="数据属性" name="third"
        ...
        >
          ...
          <fu-form-item
            label="数据取值范围_最大值"
            prop="Stat_Indct_Data_Range_Max"
          >
            <fu-input
